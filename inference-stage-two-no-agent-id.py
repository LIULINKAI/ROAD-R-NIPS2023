...
def arg_parse():
    ...
    parser.add_argument('--test_mode', type=str, default='val_1', help='test mode, only accept test or val_1')
    parser.add_argument('--video_path', type=str, default='../../../road-dataset/road/videos', help='video path')
    parser.add_argument('--yolo_path', type=str, default='runs/detect/yolov8l_base_1280_batch_4_agent3/weights/best.pt', help='yolo path')
    ...
    parser.add_argument('--yolo_name', type=str, default='base', help='semi or base')
    ...
    parser.add_argument('--devices', type=str, default='6', help='gpu id')
    ...
    parser.add_argument('--classifier_path', type=str, default='runs/vitClip-large-use-local.pkl2023-10-27-23_07_52/weight/best_weight.pt', help='action_detector_path')
        ...
        with tqdm(args.tube['triplet'][args.video_name], desc="Processing tubes") as pbar:
            for t in pbar:
                ...
                for stack_img, bbox in classifier_dataset:
                    ...
                    pred = args.action_and_location_detector(input, bbox)
